    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 md:w-1/3">
        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="proyecto_1.jpg" alt="blog" />
          <div className="p-6">
      ...
      <div className="p-4 md:w-1/3">
        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="leading-relaxed mb-3">En este proyecto reforcé mis conocimientos en frontend con React js, Vite y Tailwind CSS. Utilice librerías como axios, react-icons, react-router, etc.. Añadí un pequeño backend donde integre Checkout PRO de Mercado Pago con su SDK para Node. Asi el usuario realiza una compra unicamente con tarjeta a través del formulario de Mercado Pago. Deje muchisimos botones para seguir añadiendo funcionalidades y expandir el proyecto..¡Cuidado! Si realizas una compra efectivamente se realizará de forma real en pesos argentinos y a mi me llegará el dinero :) .. </p>
            <div className="flex items-center flex-wrap">
      ...
      <div className="p-4 md:w-1/3">
        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <h1 className="title-font text-lg font-medium text-white mb-3">Nombre proyecto 3</h1>
